...
export default function Filtro() {
  const { filtro, setFiltro, fetchData, loading } = useMesaContext();
      ...
      <Col xl={4}
        ...
        <Label title='Ordenar:'>
          <Select size='large'
            ...
            style={{ width: '100%' }}>
            <Select.Option value='numero'>Nº</Select.Option>
            <Select.Option value='descricao'>Descrição</Select.Option>
          </Select>
